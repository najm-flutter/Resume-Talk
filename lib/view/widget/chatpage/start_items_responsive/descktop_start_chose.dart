...
class DescktopStartChose extends GetView<ChatPageCoIm> {
  const DescktopStartChose({super.key});
        ...
        children: [
          ...List.generate(
            ...
            (index) {
              ...
              onTap: () => controller.onsend(" السؤال هو : ${StaticData.startItemsModel[index].body}   " , controller.typeBot),
              child: Container(
